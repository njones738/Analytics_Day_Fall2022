...
PROC MIXED DATA = group_output_df COVTEST NOCLPRINT NAMELEN = 100 IC METHOD = REML;
	...
	MODEL WDRAW_ORIG_YR2_RT = SY_ind num_reviews_POSITIVE num_reviews_NEGATIVE SY_ind*num_reviews_NEGATIVE SY_ind*num_reviews_POSITIVE  / SOLUTION DDFM = SATTERTHWAITE;
...
PROC MIXED DATA = group_output_df COVTEST NOCLPRINT NAMELEN = 100 IC METHOD = REML;
	CLASS school_sid SY_ind;
	MODEL WDRAW_ORIG_YR2_RT = num_reviews_POSITIVE num_reviews_NEGATIVE / SOLUTION DDFM = SATTERTHWAITE;
...
PROC MIXED DATA = group_output_df COVTEST NOCLPRINT NAMELEN = 100 IC METHOD = REML;
	CLASS school_sid SY_ind;
	MODEL WDRAW_ORIG_YR2_RT = time1 num_reviews_POSITIVE num_reviews_NEGATIVE num_reviews_NEGATIVE*time1 time1*num_reviews_POSITIVE  / SOLUTION DDFM = SATTERTHWAITE;
	RANDOM INTERCEPT num_reviews_POSITIVE num_reviews_NEGATIVE / G V VCORR TYPE = UN SUBJECT = school_sid;
...
PROC MIXED DATA = group_output_df COVTEST NOCLPRINT NAMELEN = 100 IC METHOD = REML;
	CLASS school_sid SY_ind;
	MODEL WDRAW_ORIG_YR2_RT = time1 num_reviews_POSITIVE num_reviews_NEGATIVE / SOLUTION DDFM = SATTERTHWAITE;
	RANDOM INTERCEPT num_reviews_POSITIVE num_reviews_NEGATIVE / G V VCORR TYPE = UN SUBJECT = school_sid;
	REPEATED SY_ind / R TYPE = VC SUBJECT = school_sid;
	ODS OUTPUT CovParms = CovFixLin InfoCrit = FitFixLin;
	ESTIMATE "Intercept at School Year = 0 ~ Time = 0"	intercept 1 time1 0;
...
PROC MIXED DATA = group_output_df COVTEST NOCLPRINT NAMELEN = 100 IC METHOD = REML;
	CLASS school_sid SY_ind;
	MODEL WDRAW_ORIG_YR2_RT = time1 num_reviews_POSITIVE num_reviews_NEGATIVE num_reviews_NEGATIVE*time1 time1*num_reviews_POSITIVE  / SOLUTION DDFM = SATTERTHWAITE;
	RANDOM INTERCEPT time1 num_reviews_POSITIVE num_reviews_NEGATIVE num_reviews_NEGATIVE*time1 time1*num_reviews_POSITIVE  / G GCORR V VCORR TYPE = UN SUBJECT = school_sid;
	REPEATED SY_ind / R TYPE = VC SUBJECT = school_sid;
...
PROC MIXED DATA = group_output_df COVTEST NOCLPRINT NAMELEN = 100 IC METHOD = REML;
	CLASS school_sid SY_ind;
	MODEL WDRAW_ORIG_YR2_RT = time1 num_reviews_POSITIVE num_reviews_NEGATIVE time1*time1 time1*num_reviews_POSITIVE  time1*time1*num_reviews_POSITIVE time1*num_reviews_NEGATIVE time1*time1*num_reviews_NEGATIVE / SOLUTION DDFM = SATTERTHWAITE;
	RANDOM INTERCEPT time1 num_reviews_POSITIVE num_reviews_NEGATIVE num_reviews_NEGATIVE*time1 time1*num_reviews_POSITIVE  / G GCORR V VCORR TYPE = UN SUBJECT = school_sid;
	REPEATED SY_ind / R TYPE = VC SUBJECT = school_sid;
...
PROC MIXED DATA = group_output_df COVTEST NOCLPRINT NAMELEN = 100 IC METHOD = REML;
	CLASS school_sid SY_ind;
	MODEL WDRAW_ORIG_YR2_RT = time1 num_reviews_NEGATIVE num_reviews_POSITIVE  time1*time1 time1*num_reviews_POSITIVE  time1*time1*num_reviews_POSITIVE time1*time1 time1*num_reviews_NEGATIVE  time1*time1*num_reviews_NEGATIVE / SOLUTION DDFM = SATTERTHWAITE;
	RANDOM INTERCEPT time1 num_reviews_POSITIVE num_reviews_NEGATIVE time1*time1 / G GCORR V VCORR TYPE = UN SUBJECT = school_sid;
	REPEATED SY_ind / R TYPE = VC SUBJECT = school_sid;
